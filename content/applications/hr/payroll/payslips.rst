...
In Odoo, the :menuselection:`Payroll` applications handles the processing of payslips and the
distribution of payments, in addition to managing work entries, reports, employee information, and
contracts.

Payslips are created either by the employees themselves or their managers, are approved by
authorized employees (typically managers). Finally, once payslips are approved, employees are issued
